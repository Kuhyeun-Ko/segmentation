...
def save_checkpoint(state, is_best, filename='checkpoint.pth.tar'):
    ...
    if is_best:
        shutil.copyfile(filename, 'checkpoints/drn/model_best.pth.tar')
...
def train_seg(args):
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        checkpoint_path = 'checkpoints/drn/checkpoint_latest.pth.tar'
        save_checkpoint({
            'epoch': epoch + 1,
            'arch': args.arch,
        ...
        if (epoch + 1) % 1 == 0:
            history_path = 'checkpoints/drn/checkpoint_{:03d}.pth.tar'.format(epoch + 1)
